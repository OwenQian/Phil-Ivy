...
ChoiceNode.cpp OpponentNode.cpp GameUtilities.cpp main.cpp arrays.cpp fast_eval.cpp Decision.cpp
INCLUDES = $(wildcard *.h)
OBJDIR   = obj

# Prefixes each of the object files with obj/
OBJECTS  = $(addprefix $(OBJDIR)/, Player.o GameObject.o \
potInfo.o Node.o helper.o ChoiceNode.o GameUtilities.o OpponentNode.o arrays.o fast_eval.o Decision.o main.o )
